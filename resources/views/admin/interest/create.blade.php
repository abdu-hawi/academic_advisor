                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body register-card-body">
                            ...
                            <div class="mb-0">
                                {!! Form::select('first_course',App\Model\Course::where("type","Optional")->pluck("code",'id'),old('first_course'),
                                        ['class'=>"form-control",'placeholder'=>"Select first course"]) !!}
                            </div>

                            <div><b>Second Course: </b></div>
                            <div class="mb-3">
                                {!! Form::select('second_course',App\Model\Course::where("type","Optional")->pluck("code",'id'),old('second_course'),
                                        ['class'=>"form-control",'placeholder'=>"Select first course"]) !!}
                            </div>
