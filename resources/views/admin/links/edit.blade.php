                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li><a href="{!! aurl('links') !!}">Links</a> /</li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body register-card-body col-6" style="margin-left: auto;margin-right: auto;">
                            {!! Form::open(['url'=>aurl('links/'.$link->id),'method'=>'put']) !!}
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="title" value="{!! $link->title !!}" placeholder="Title" required>
                            ...
                            <div class="input-group mb-3">
                                <input type="url" class="form-control" name="url" value="{!! $link->url !!}" placeholder="Link" required>
                                <div class="input-group-append">
                                    <div class="input-group-text">
