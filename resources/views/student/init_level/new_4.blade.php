                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                @include('student.init_level.level_new4_2')
                            </div>
                            <div class="mb-3">
                                <?php
                                $countCourse = count($level[2]);
                                $gpaLevel3 = 0;
                                ...
                                @include('student.init_level.level_new4_3')
                            </div>

                            <hr>
                            <h5><b class="text-red mr-2">GPA:</b>{!! round($gpa/3,2) !!}</h5>
                            <input type="submit" class="btn btn-success mt-2" value="Agree Plane"/>
                            <a href="{!! studentURL('plans/edit/'.$id) !!}"><input type="button" class="btn btn-dark mt-2" value="Edit Plane"/></a>
                            {!! Form::close() !!}
                        </div>
                        <!-- /.card-body -->
                    </div>
