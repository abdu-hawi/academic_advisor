                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <b>Level 4</b>
                            <div class="row block mb-4" id="4" style="width: 100%; background: lightpink; padding-top: 10px; max-height: 250px;min-height: 100px;">
                            </div>
        ...
        $('.block').sortable({
            ...
            receive:function (event,ui) {
                ...
                if (event.target.childElementCount > 3){
                    if (level !== 'mam'){
                        $("#"+a).sortable("cancel");
                        alert("You can't add more than 3 courses in level")
                    }
                }else if (code === '699' && level !== '4'){
                    $("#"+a).sortable("cancel");
                    alert("This is thesis course you can add just in level 4")
