                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <h3 class="text-dark">
                                Drag the row for the course and drop it where you want, noting the following:
                            </h3>
                                <h4>
                                    <ul class="text-danger">
                                        <li style="list-style-type: disc">Attention to courses that require a course before it.</li>
                                        <li style="list-style-type: disc">Two courses cannot be placed in the same interest at the same level.</li>
                                    </ul>
                                </h4>
                                ...
                                <button class="btn btn-dark" onclick="addLevel()">Add Level</button><br>
                                <button class="btn btn-primary mt-2" onclick="saveP()">SAVE PLAN</button>
                        </div>
                        {!! Form::open(['url'=>studentURL('plans/'.$id),'method'=>'put','id'=>'form_edit']) !!}
