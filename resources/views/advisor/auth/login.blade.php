...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="{!! advisorURL('login') !!}" method="post">
                {!! csrf_field() !!}
            ...
            <p class="mb-1">
                <a href="{!! advisorURL('forgotPassword') !!}" class="text-success">I forgot my password</a>
            </p>
            <p class="mb-0">
                <a href="{!! advisorURL('register') !!}" class="text-center text-success">Register a new membership</a>
            </p>
